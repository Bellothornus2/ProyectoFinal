...
app.register_blueprint(alcohol.get_alcohol_human_readable_blueprint)
app.register_blueprint(alcohol.get_all_alcohol_human_readable_blueprint)
app.register_blueprint(alcohol.get_alcohol_by_type_alcohol_human_readable_blueprint)
app.register_blueprint(alcohol.get_alcohol_by_subtype_alcohol_human_readable_blueprint)
